        ...
        <>
            <header role="banner">
                <nav role="navigation" aria-label="Menu principal" className="menu_container">
                    <div className="logo"><a href="/"><img loading="lazy" src={Logo} alt="GreenRoots (logo)"></img></a></div>
                    <ul className="menu_list">
                        ...
                        <li><img loading="lazy" className="profil" src={person} alt="person" /></li>
                        <li>{isLoggedIn ? <><a href='/profil'>Mon espace</a></>: <><a href="/connexion">Connexion</a></>}</li>
                        <li>{isLoggedIn ? <><button onClick={handleLogout}>Déconnexion</button></>:<><a href="/inscription">Inscription</a></>}</li>
                        <li><Search/></li>
                    </ul>
                </nav>
            </header>
